                ...
                <div class="box">
                    ...
                    <div class="upload-wrapper">
                      ...
                      <div id="dropzone" class="dropzone-wrapper">
                              ...
                              <span class="button btn-blue input-file">
                                  Browse Files <input type="file" id="fileupload" name="files[]" data-url="{{ route('spiderworks.miniweb.media.save')}}" multiple />
                              </span>
                      </div>
                  ...
                  <div class="box-body">
                      ...
                      <div class="row" id="mediaList">
                        @include('spiderworks.miniweb.media.ajax_index', ['files'=>$files])
                      </div>
                  </div><!-- /.box-body -->
