	   ...
	   <div class="panel with-nav-tabs panel-default">
                ...
                <div class="panel-body">
                    <div class="tab-content">
                        ...
                        @php
                          $data_url = route('spiderworks.miniweb.media.save');
                        @endphp
                        ...
                        <div class="tab-pane @if(count($files)>0) active show @endif" id="tab2Media">
                          ...
                          <div class="text-right">
                              ...
                              @else
                                <button class="btn btn-primary" id="addPhotos" @if($popup_type == 'photos') data-url="{{url('admin/photos/save')}}" @elseif($popup_type == 'sliders') data-url="{{url('admin/sliders/update', ['id'=>$id])}}" @endif><i class="glyphicon glyphicon-plus-sign"></i> Add Photos</button>
                              @endif
                          </div>
                        </div>
                    </div>
