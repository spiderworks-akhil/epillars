                        ...
                        <div class="col-md-6">
                            <div class="row column-seperation padding-5">
                                <div class="form-group form-group-default form-group-default-select2 required">
                                  ...
                                  <select name="position" class="full-width miniweb-select2-input">
                              ...
                              <div class="dd">
                                  <ol class="dd-list custom-accordion-menu">
                                    @if($obj->id && $obj->menu_items)
                                      @include('spiderworks.miniweb._partials.menu', ['items'=>$obj->menu_items])
                                    @endif
                                  </ol>
                              </div>
...
@endsection
@section('bottom')
    <script src="{{ asset('miniweb/js/jquery.nestable.js')}}"></script> 
